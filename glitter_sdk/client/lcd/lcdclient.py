...
from glitter_sdk.core import Coins, Dec, Numeric
from glitter_sdk.exceptions import LCDResponseError
from glitter_sdk.key.key import Key
from glitter_sdk.util.json import dict_to_data
...
class AsyncLCDClient:
    ...
    def DB(self, key: Key) -> AsyncDB:
        """Creates a :class:`AsyncDB` object from a key.

        Args:
            key (Key): key implementation
        """
        return AsyncDB(self, key)
...
class LCDClient(AsyncLCDClient):
    ...
    auth: AuthAPI
    """:class:`AuthAPI<glitter_sdk.client.lcd.api.auth.AuthAPI>`."""

    bank: BankAPI
    """:class:`BankAPI<glitter_sdk.client.lcd.api.bank.BankAPI>`."""

    distribution: DistributionAPI
    """:class:`DistributionAPI<glitter_sdk.client.lcd.api.distribution.DistributionAPI>`."""

    gov: GovAPI
    """:class:`GovAPI<glitter_sdk.client.lcd.api.gov.GovAPI>`."""

    feegrant: FeeGrantAPI
    """:class:`FeeGrant<glitter_sdk.client.lcd.api.feegrant.FeeGrantAPI>`."""

    mint: MintAPI
    """:class:`MintAPI<glitter_sdk.client.lcd.api.mint.MintAPI>`."""

    authz: AuthzAPI
    """:class:`AuthzAPI<glitter_sdk.client.lcd.api.authz.AuthzAPI>`."""

    slashing: SlashingAPI
    """:class:`SlashingAPI<glitter_sdk.client.lcd.api.slashing.SlashingAPI>`."""

    staking: StakingAPI
    """:class:`StakingAPI<glitter_sdk.client.lcd.api.staking.StakingAPI>`."""

    tendermint: TendermintAPI
    """:class:`TendermintAPI<glitter_sdk.client.lcd.api.tendermint.TendermintAPI>`."""

    wasm: WasmAPI
    """:class:`WasmAPI<glitter_sdk.client.lcd.api.wasm.WasmAPI>`."""

    tx: TxAPI
    """:class:`TxAPI<glitter_sdk.client.lcd.api.tx.TxAPI>`."""

    ibc: IbcAPI
    """:class:`IbcAPI<glitter_sdk.client.lcd.api.ibc.IbcAPI>`."""

    ibc_transfer: IbcTransferAPI
    """:class:`IbcTransferAPI<glitter_sdk.client.lcd.api.ibc_transfer.IbcTransferAPI>`."""
    ...
    def db(self, key: Key) -> DB:  # type: ignore
        """Creates a :class:`DB` object from a key for easy transaction creating and
        signing.
