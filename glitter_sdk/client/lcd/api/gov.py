...
from glitter_sdk.core import Coins, Dec
from glitter_sdk.core.deposit import Deposit
from glitter_sdk.core.gov import Proposal, ProposalStatus, WeightedVoteOption
from glitter_sdk.core.gov.data import Vote
    ...
    async def proposals(
        ...
        Args:
            options (dict, optional): dictionary containing options. Defaults to {}. you can use one or more below:
                {
                    "proposal_status": glitter_sdk.core.gov.ProposalStatus (int)
