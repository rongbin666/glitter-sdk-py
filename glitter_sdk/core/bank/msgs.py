...
from glitter_proto.cosmos.bank.v1beta1 import MsgSend as MsgSend_pb
...
@attr.s
class MsgSend(Msg):
    """Sends native Glitter assets (Luna or Glitter stablecoins) from ``from_address`` to ``to_address``.
