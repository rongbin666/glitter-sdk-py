...
from glitter_proto.cosmos.authz.v1beta1 import (
    GenericAuthorization as GenericAuthorization_pb,
)
from glitter_proto.cosmos.authz.v1beta1 import Grant as Grant_pb
from glitter_proto.cosmos.bank.v1beta1 import SendAuthorization as SendAuthorization_pb
from glitter_proto.cosmos.staking.v1beta1 import AuthorizationType
...
from glitter_sdk.core import AccAddress, Coin, Coins
...
class Authorization(BaseTerraData):
    ...
    def from_amino(amino: dict) -> Authorization:
        from glitter_sdk.util.parse_authorization import parse_authorization_amino

        return parse_authorization_amino(amino)

    @staticmethod
    def from_data(data: dict) -> Authorization:
        from glitter_sdk.util.parse_authorization import parse_authorization

        return parse_authorization(data)

    @staticmethod
    def from_proto(proto: Any_pb) -> Authorization:
        from glitter_sdk.util.parse_authorization import parse_authorization_proto

        return parse_authorization_proto(proto)

    @staticmethod
    def unpack_any(proto: Any_pb) -> Authorization:
        from glitter_sdk.util.parse_authorization import parse_authorization_unpack_any
...
class SendAuthorization(Authorization):
    """Type of :class:`Authorization` for :class:`MsgSend<glitter_sdk.core.bank.msgs.MsgSend>`,
