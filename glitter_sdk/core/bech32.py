...
AccAddress.__doc__ = """Glitter Bech32 Account Address -- type alias of str."""

ValAddress = NewType("ValAddress", str)
ValAddress.__doc__ = """Glitter Bech32 Validator Operator Address -- type alias of str."""

AccPubKey = NewType("AccPubKey", str)
AccPubKey.__doc__ = """Glitter Bech32 Account Address -- type alias of str."""

ValPubKey = NewType("ValPubKey", str)
ValPubKey.__doc__ = """Glitter Bech32 Validator PubKey -- type alias of str."""

# ValConsPubKey = NewType("ValConsPubKey", str)
# ValConsPubKey.__doc__ = (
#  """Glitter Bech32 Validator Conensus PubKey -- type alias of str."""
# )


def is_acc_address(data: str) -> bool:
    """Checks whether the given string is a properly formatted Glitter account address.
...
def is_val_address(data: str) -> bool:
    """Checks whether the given string is a properly formatted Glitter validator operator
    address.
...
def is_acc_pubkey(data: str) -> bool:
    """Checks whether the provided string is a properly formatted Glitter account pubkey.
...
def is_val_pubkey(data: str) -> bool:
    """Checks whether provided string is a properly formatted Glitter validator pubkey.
...
def is_valcons_pubkey(data: str) -> bool:  # -> ValConsPubKey:
    """Checks whether provided string is a properly formatted Glitter validator consensus
    pubkey.
