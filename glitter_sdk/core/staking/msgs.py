...
from glitter_proto.cosmos.staking.v1beta1 import MsgDelegate as MsgDelegate_pb
from glitter_proto.cosmos.staking.v1beta1 import MsgEditValidator as MsgEditValidator_pb
from glitter_proto.cosmos.staking.v1beta1 import MsgUndelegate as MsgUndelegate_pb

from glitter_sdk.core import AccAddress, Coin, Dec, PublicKey, ValAddress, ValConsPubKey
...
class MsgCreateValidator(Msg):
    """Register a new validator with the Glitter protocol.
